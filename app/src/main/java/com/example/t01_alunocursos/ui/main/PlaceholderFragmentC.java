 ...
 */
public class PlaceholderFragmentC extends Fragment {

    private static final String ARG_SECTION_NUMBER = "section_number";

    private PageViewModelA pageViewModelA;

    public static PlaceholderFragmentC newInstance(int index) {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.activity_cursos, container, false);
        final TextView textView = root.findViewById(R.id.section_label_Curso);
